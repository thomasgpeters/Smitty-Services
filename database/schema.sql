...
-- Run once on a fresh database, then follow with seed_data.sql.
-- ==============================================================================
...
CREATE TABLE customer_customer_demo (
    customer_id character varying(5) NOT NULL REFERENCES customers(customer_id),
    customer_type_id character varying(5) NOT NULL REFERENCES customer_demographics(customer_type_id),
...
CREATE TABLE employee_territories (
    ...
    territory_id character varying(20) NOT NULL REFERENCES territories(territory_id),
